...
def generate_launch_description():
    robot_name_in_model = 'mycobot_280_m5_gazebo'
    package_name = 'mycobot_description'
    urdf_name = "mycobot_280_m5_gazebo.urdf"

    pkg_share = FindPackageShare(package=package_name).find(package_name) 
    urdf_model_path = os.path.join(pkg_share, f'urdf/mycobot_280_m5/{urdf_name}')
    ...
    follow_display_node = Node(
        package="mycobot_280_gazebo_moveit",
        executable="follow_up",
        name="follow_up",
        output="screen",
    )
    ...
    ld.add_action(follow_display_node)
